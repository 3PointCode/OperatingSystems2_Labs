...
if [ -L "dane/atom" ]; then     # sprawdzenie czy dowiązanie symboliczne istnieje dla pliku atom
    target_file=$(readlink -f "dane/atom")  # pobranie ścieżki do docelowego pliku
    cat "$target_file"
fi