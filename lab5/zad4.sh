...
tail -n +2 dodatkowe/ps-aux | cut -d' ' -f1 | sort -u
# pominięcie pierwszej nagłówka, wycięcie pierwszego pola przy użyciu cut oraz posortowanie i usunięcie duplikatów