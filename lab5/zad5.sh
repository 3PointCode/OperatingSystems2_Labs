...
# wyodrębnienie lini zaczynających się od słowa syslog, zamiana wielokrotnych spacji do jednej, pobranie drugiego pola np 514/udp
# pobranie pierwszego pola gdzie delimiter to /, a następnie posortowanie i usunięcie duplikatów