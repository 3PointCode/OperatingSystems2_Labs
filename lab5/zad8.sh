...
grep -rlx '#include <stdio.h>' coreutils-8.32 | wc -l
# rekursywne przeszukanie wszystkich plików w zadanym dir, wyświetlenie plików, które matchują, wybranie tylko tych par,  które dokładnie pasują do zadanej linii
# zliczenie ilości