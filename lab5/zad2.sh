...
cat dodatkowe/etc-passwd | grep -vE -e "bin/nologin" -e "bin/false" | cut -d':' -f1
# pobranie zawartości pliku i zrobienie inverse match sprawdzając czy bin/nologin i bin/false znajdują się w ścieżce pliku
# wycięcie 1 części czyli nazwy użytkownika oddzielonej dwukropkiem