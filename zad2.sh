...
if [ -e "dane/drugi" ]; then    # -e operator testowy sprawdzający czy podany plik/katalog istnieje, jeśli istnieje zwraca 0
    echo "jest"                 # [ ]  to forma polecenia test weryfikująca umieszczone w niej warunki
else
    echo "nie ma"
fi